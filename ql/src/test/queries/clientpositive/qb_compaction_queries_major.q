...
-- The point of this test frogmethod
...
insert into test_update_bucketed values ('1','one'),('2','two'),('3','three'),('4','four'),('5','five'),('6','six'),('7','seven'),('8','eight'),('9','nine'),('10','ten'),('11','eleven'),('12','twelve'),('13','thirteen'),('14','fourteen'),('15','fifteen'),('16','sixteen'),('17','seventeen'),('18','eighteen'),('19','nineteen'),('20','twenty');delete from test_update_bucketed where id in ('2', '11', '10');delete from test_update_bucketed where id in ('2', '4', '12', '15');
...
select ROW__ID, * from default.test_update_bucketed;

select validate_acid_sort_order(ROW__ID.writeId, ROW__ID.bucketId, ROW__ID.rowId) from default.test_update_bucketed;
